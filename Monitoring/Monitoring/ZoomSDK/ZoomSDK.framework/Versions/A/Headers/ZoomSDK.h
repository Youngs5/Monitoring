...
#import "ZoomSDKReminderController.h"
...
@property (retain, nonatomic) NSString *teamIdentifier DEPRECATED_MSG_ATTRIBUTE("No longer used");
...
/**
 * @brief Get object of controller ZoomSDKDisclaimerController.
 * @return If the function succeeds, it will return a ZoomSDKReminderController object.
 */
