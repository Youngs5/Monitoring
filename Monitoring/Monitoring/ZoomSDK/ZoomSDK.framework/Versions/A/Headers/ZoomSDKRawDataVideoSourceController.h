 ...
 */
- (void)sendRawData:(char*)data width:(unsigned int)width height:(unsigned int)height dataLength:(unsigned int)length ratation:(ZoomSDKLocalVideoDeviceRotation)ratation DEPRECATED_MSG_ATTRIBUTE("Use -sendRawData: width: height: dataLength: ratation: format: instead");
