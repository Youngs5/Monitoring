...
@interface ZoomSDKMeetingConfiguration :NSObject
{
    ...
    //Set the feedback button’s visibility on cloud Whiteboard. Default is displaying.
    BOOL                _hideCloudWhiteboardFeedbackButton;
    //Set the share button’s visibility on cloud Whiteboard. Default is displaying.
    BOOL                _hideCloudWhiteboardShareButton;
    //Set the about button’s visibility on the cloud whiteboard. Default is displaying.
