...
/**
 @brief The strategy when face recognition failed. For more details, see {@link ZoomSDKFaceRecognitionFailStrategy}.
 */
 ...
 * @param mode The mode of auto-framing. For more details, see {@link ZoomSDKAutoFramingMode}.
 * @return If the function succeeds, it will return ZoomSDKError_Success, otherwise not.
 */
...
/**
 * @brief Set the fail strategy of face recognition when auto-framing is enabled(mode is ZoomSDKAutoFramingMode_Face_Recognition).
 * @param strategy The fail strategy of face recognition. For more details, see {@link ZoomSDKFaceRecognitionFailStrategy}.
 * @return If the function succeeds, it will return ZoomSDKError_Success, otherwise not.
 */
